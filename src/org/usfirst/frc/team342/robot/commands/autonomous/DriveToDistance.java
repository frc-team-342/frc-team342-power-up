...
public class DriveToDistance extends Command {
	...
	public enum Distance {
		...
		CENTER_SWITCH_LEFT(12), CENTER_SWITCH_RIGHT(10.8), SCALE_ACROSS(0), SIDE_SWITCH(17.316), SCALE_DISTANCE(37.179), DRIVE_IN_DISTANCE_SCALE(0.5), DRIVE_IN_DISTANCE_SWITCH(3), DRIVE_OFF_WALL(1), DRIVE_FORWARD_DISTANCE(13),DRIVE_TO_CUBES(5);
		//SIDE_SWITCH(13.5)
