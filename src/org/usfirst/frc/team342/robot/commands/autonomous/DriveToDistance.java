...
public class DriveToDistance extends Command {
	...
	public enum Distance {
		...
		CENTER_SWITCH_LEFT(10 * 0.95), CENTER_SWITCH_RIGHT(10.2 * 0.95), SCALE_ACROSS_PLATFORM_ZONE(19.098 * 0.95), PLATFORM_ZONE_WALL(25.05 * 0.95), SCALE_FROM_PLATFORM_ZONE(0 * 0.95), SIDE_SWITCH(17.316 * 0.95), SCALE_DISTANCE(37.179 * 0.95), DRIVE_IN_DISTANCE_SCALE(0.5 * 0.95),
