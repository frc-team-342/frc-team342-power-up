...
public class DriveToDistance extends Command {
	...
	public enum Distance {
		...
		CENTER_SWITCH_RIGHT(9), CENTER_SWITCH_LEFT(12), SIDE_SWITCH(15), SCALE_DISTANCE(35), DRIVE_IN_DISTANCE_SCALE(0.5), DRIVE_IN_DISTANCE_SWITCH(3), DRIVE_OFF_WALL(1), DRIVE_FORWARD_DISTANCE(13);
		//SIDE_SWITCH(13.5)
