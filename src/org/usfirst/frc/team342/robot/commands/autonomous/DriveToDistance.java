...
public class DriveToDistance extends Command {
	...
	public enum Distance {
		...
		CENTER_SWITCH_LEFT(12), CENTER_SWITCH_RIGHT(10.8), SCALE_ACROSS(0), SIDE_SWITCH(17.316), SCALE_DISTANCE(36.5), DRIVE_IN_DISTANCE_SCALE(0.5),
		DRIVE_IN_DISTANCE_SWITCH(3), DRIVE_OFF_WALL(1), DRIVE_FORWARD_DISTANCE(13), DRIVE_OFF_SWITCH_WALL(2), DRIVE_TO_PLATFORM_ZONE_FROM_SWITCH(3.66),
		DRIVE_TO_CUBE_SWITCH(2.87), DRIVE_TO_CUBES(5);
